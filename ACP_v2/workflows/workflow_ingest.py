...
class IngestionWorkflow:
    ...
    def _phase_ingest(self):
        ...
        from tools.core.ingest import main as ingest_main
        # Save original argv
        original_argv = sys.argv
        try:
            # Set argv for ingest script
            sys.argv = ['tools/core/ingest.py', str(self.file_path)]
            ingest_main()
        finally:
    ...
    def _phase_symbols(self):
        ...
        try:
            from tools.analysis.symbol_resolver import main as resolve_symbols
            resolve_symbols()
        except (ImportError, AttributeError):
            from tools.analysis import symbol_resolver  # noqa: F401
            pass
    ...
    def _phase_governance(self):
        ...
        from tools.analysis.rule_engine import RuleEngine
        engine = RuleEngine()
        engine.run()
